...
def test_reopening_a_project_moves_it_to_front_without_duplicating():
    app_settings.save_last_project_dir("/tmp/a")
    app_settings.save_last_project_dir("/tmp/b")
    app_settings.save_last_project_dir("/tmp/a")
...
def test_recent_project_dirs_capped(monkeypatch):
