...
# Cache dir name for playlist thumbnails, nested under a project's own
# project_dir (not the videos_dir, which the user doesn't necessarily own
# write access to or want app-generated files mixed into).
