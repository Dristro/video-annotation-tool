...
class TestPlayPauseButtonSize:
    def test_button_has_fixed_width(self, panel) -> None:
        assert panel._play_btn.minimumWidth() == panel._play_btn.maximumWidth()

    def test_width_unchanged_across_play_pause_toggle(self, panel) -> None:
        widths = set()
    ...
    def test_fixed_width_fits_both_labels(self, panel) -> None:
...
class TestSpeedSlider:
    def test_default_speed_is_1x(self, panel) -> None:
    ...
    def test_slider_is_notched_over_discrete_steps(self, panel) -> None:
    ...
    def test_moving_slider_updates_label(self, panel) -> None:
    ...
    def test_moving_slider_without_a_player_does_not_raise(self, panel) -> None:
