...
def test_list_videos_filters_extensions_and_sorts(tmp_videos_dir):
...
def test_list_videos_missing_dir_returns_empty(tmp_path):
    assert list_videos(str(tmp_path / "does-not-exist")) == []


def test_rel_path_for(tmp_videos_dir):
